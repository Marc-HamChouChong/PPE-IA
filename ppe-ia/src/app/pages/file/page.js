export default function Page() {
  return (
    <div>
      <div className="mb-4">
        <label htmlFor="input" className="block font-medium mb-2">Article File :</label>
        <textarea id="input" rows="2" placeholder="File" className="w-full p-2 border border-gray-300 rounded bg-gray-100"></textarea>
